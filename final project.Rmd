...
accident may reach an average of 80-100 accidents per day in the Jan , the module random walk is more likely to be the best fitting module because the standard error is almost constant which can be as constant regression.in this case in the using Ljung box null hypothesis we will reject the null hypothesis for ARIMA(4,1,0) and go with  random walk (0,1,1) .  
